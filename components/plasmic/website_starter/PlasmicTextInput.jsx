...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: wSzbpnB4Jh8m/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__sb7LF)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg___2RwXi)}
              role={"img"}
            />
          ),
