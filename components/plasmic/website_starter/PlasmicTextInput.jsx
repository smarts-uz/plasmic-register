...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 81qtj7VPT0w4/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: zD3MkWxHjJXb/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__wHu7I)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg___9ChYi)}
              role={"img"}
            />
          ),
